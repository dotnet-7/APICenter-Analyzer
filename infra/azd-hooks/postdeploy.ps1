...
az eventgrid event-subscription create --name MyEventSubscription --source-resource-id "$azureApiCenterId" --endpoint "$azureFunctionId" --endpoint-type azurefunction --included-event-types Microsoft.ApiCenter.ApiDefinitionAdded Microsoft.ApiCenter.ApiDefinitionUpdated
